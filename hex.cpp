...
Hex::Hex() : size(0), turn(0), counter(0), gameStatus(true), hexCells(nullptr)
{
	// gets the user input
	playGame();
...
Hex::Hex(int s, int gT) : size(s), turn(0), counter(0), gameType(gT), gameStatus(true), hexCells(nullptr)
{
	initHexCells();
}

Hex::Hex(int s, int gT, string &filename) : size(s), turn(0), counter(0), gameType(gT), gameStatus(true), hexCells(nullptr)
{
	initHexCells();
